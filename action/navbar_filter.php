        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" style="right: 10px">
                <form method="POST" action="<?= escape('filterproduct.php');?>" class="form-group">
                    <input type="hidden" name="low" value="2019-07-22">
                    <input type="hidden" name="high" value="2020-08-22">
                ...
                <form method="POST" action="<?= escape('filterproduct.php');?>" class="form-group mt-1">
                    <input type="hidden" name="low" value="2019-07-22">
                    <input type="hidden" name="high" value="2021-08-22">
                    <button type="submit" name="filter" class="btn btn-outline-primary btn-small filter">2019-07 - The latest</button>
                </form>
            </ul>
        </li>
        <li class="nav-item dropdown">
